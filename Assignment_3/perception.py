...
#Paste your own working perception.py solution from Assignment 2 in here to test
#odometry.py locally end-to-end. See README.md's Submission section.
...
def detect_obstacles(image, lidar_scan, robot_state, tracked_obstacles):
    ...
    #    odometry.py this assignment, not ground truth) - use it to convert a
    #    detection from the robot/camera frame into world coordinates. Since
    #    robot_state can now drift from the truth, a detected obstacle's
    #    world position inherits that same drift - that's expected.
